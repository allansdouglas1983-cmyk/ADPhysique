...
**In-app rules text, version 1.** Shown on the Join screen before a
...
`40-DECISIONS.md` SD-04, SD-11. `COMMUNITY_RULES_VERSION = 1`.
...
Community rules version **1**, published **6 September 2026**. Any future
...
// Community Rules v1, paste-ready for CommunityRulesScreen.
